            ...
            <div class="container mx-auto">
                <div class="max-w-md mx-auto my-10">
                    <div class="text-center">
                        <h1 class="my-3 text-3xl font-semibold text-gray-700">Sign in to access your account</h1>
                    </div>
                    <div class="m-7">
                        <form action="">
                            <div class="mb-6">
                            ...
                            <div class="mb-6">
                                <div class="flex justify-between mb-2">
                                    ...
                                    <a href="#!" class="text-sm text-gray-400 focus:outline-none focus:text-indigo-500 hover:text-indigo-500 dark:hover:text-indigo-700">Forgot password?</a>
                                </div>
                            ...
                            <p class="text-sm text-center text-gray-400">Don't have an account yet? <a href="/sign-up" class="text-indigo-400 focus:outline-none focus:underline focus:text-indigo-500 dark:focus:border-indigo-800">Sign up</a>.</p>
                        </form>
                    </div>
                </div>
            </div>
